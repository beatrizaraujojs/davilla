               <!-- Modal  Nova  Categoria -->
                <div class="modal fade" id="modalEditarCategoria{{ $categoria->id_categoria }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
               ...
               <form method="POST" action="{{ route('admin.categoria.update', $categoria->id_categoria) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="descricao_categoria" name="descricao_categoria" rows="3" aria-describedby="alerta-descricao"  Required value="{{ $categoria->descricao_categoria }}"></textarea>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="number" class="form-control" id="ordem_categoria" name="ordem_categoria" aria-describedby="alerta-ordem_categoria" Required value="{{ $categoria->ordem_categoria }}">
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-select" aria-label="Selecione uma opção" name="status_categoria" aria-describedby="alerta-ordem_categoria"  Required value="{{ $categoria->status_categoria }}">
