                ...
                <form method="POST" action="{{ route('admin.categoria.store') }}">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            name="nome_categoria"
                             aria-describedby="alerta-nome_categoria"  Required>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-select" aria-label="Selecione uma opção" name="status_categoria" aria-describedby="alerta-ordem_categoria"  Required>
