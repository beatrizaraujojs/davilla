            ...
            <div class="filter-list row">
              ...
              <div class="portfolio-block-four all mix categoria-{{ $linha->id_categoria }} col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image">
                                <img src="{{ asset('davilla/images/'.$linha->foto_produto) }}" alt="{{ $linha->nome_produto }}"></figure>
                        ...
                        <div class="lower-content">
                            <div class="title-box">
                                <h3><a href="{{ route('cardapio.produto', $linha->id_produto) }}"><svg class="div_left" viewBox="0 0 152 51">
                                        ...
                                        </svg>{{ $linha->nome_produto }}<svg class="div_right" viewBox="0 0 152 51">
                            ...
                            <div class="text">{{ illuminate\Support\Str::limit($linha->descricao_produto, 10) }}</div>
