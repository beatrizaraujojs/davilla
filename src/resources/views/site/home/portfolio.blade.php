    <section class="portfolio-section">
        <div class="auto-container">
            ...
            <div class="row">
                ...
                @foreach ($listaProduto->shuffle()->take(8) as $linha)
                <!-- Portfolio Block -->
                <div class="portfolio-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">      <figure class="image"><img src="{{ asset("davilla/images/produto/$linha->slug_produto.png") }}" alt="{{ $linha->nome_produto }}"></figure></figure></div>
                          ...
                          <a href="{{ asset("davilla/images/produto/$linha->slug_produto.png") }}" class="lightbox-image link" data-fancybox="portfolio"></a>
                            <h3><a href="{{ route('cardapio.produto', $linha->slug_produto) }}">{{ $linha->nome_produto }}</a></h3>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <style>
    /* 1. FORÇANDO O GRID E MATANDO O BOOTSTRAP ANTIGO */
    ...
    /* ESSA É A MÁGICA: Remove os elementos fantasmas do Bootstrap que quebram o Flexbox */
    ...
    .portfolio-block {
        ...
        box-sizing: border-box !important; /* Garante que o padding não faça o card passar de 25% */
        display: flex;
    }

    @media (max-width: 991px) { .portfolio-block { width: 50% !important; } }
    @media (max-width: 767px) { .portfolio-block { width: 100% !important; } }
    ...
    .portfolio-block .inner-box:hover { transform: translateY(-8px); }

    /* 3. DOMANDO AS IMAGENS */
    .portfolio-block .image-box,
    .portfolio-block figure.image {
        width: 100% !important;
    ...
    .portfolio-block figure.image img {
        width: 100% !important;
    ...
    .portfolio-block .inner-box:hover figure.image img { transform: scale(1.08); }

    /* Esconde as sujeiras do template */
    .portfolio-block .hover-effect,
    .portfolio-block .hover-effect svg,
    .portfolio-block .lightbox-image.link { display: none !important; }
    ...
    .portfolio-block h3 a:hover { color: #55a8a1; }
</style>